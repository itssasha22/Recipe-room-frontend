...
const RecipeDetail = () => {
  ...
  const recipes = {
    ...
    15: { name: 'Cheesecake', chef: 'Chef Grace', time: '50 mins', servings: 8, rating: 5, image: 'https://images.unsplash.com/photo-1508737027454-e6454ef45afd?w=800', ingredients: ['Cream cheese', 'Graham crackers', 'Sugar', 'Eggs', 'Vanilla', 'Butter'], steps: ['Make graham cracker crust', 'Beat cream cheese with sugar', 'Add eggs one at a time', 'Pour into crust', 'Bake in water bath', 'Chill overnight'] },
